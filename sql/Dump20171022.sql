...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-10-11 20:58:26',NULL),('diagnostics.include_raw','OFF','2017-10-11 20:58:26',NULL),('ps_thread_trx_info.max_length','65535','2017-10-11 20:58:26',NULL),('statement_performance_analyzer.limit','100','2017-10-11 20:58:26',NULL),('statement_performance_analyzer.view',NULL,'2017-10-11 20:58:26',NULL),('statement_truncate_len','64','2017-10-11 20:58:26',NULL);
...
--
-- Current Database: `biblioteka`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `biblioteka` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci */;
...
CREATE TABLE `ksiazki` (
  ...
  `NAZWA_KSIAZKI` varchar(100) COLLATE utf8_polish_ci NOT NULL,
  `IMIONA_AUTO` varchar(45) COLLATE utf8_polish_ci NOT NULL,
  `NAZWISKO_AUTO` varchar(45) COLLATE utf8_polish_ci NOT NULL,
  `DATA_WYDANIA` date DEFAULT NULL,
  `KATEGORIA` varchar(45) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`ID_KSIAZKI`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci COMMENT='tabela ksiazek';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ksiazki` VALUES (1,'Niewidzialny w sieci. Sztuka zacierania śladów','Kevin','Mitnick','2017-08-17','Naukowa'),(2,'HTML i CSS. Zaprojektuj i zbuduj witrynę WWW','Jon','Duckett','2014-01-23','Naukowa'),(3,'Jak zawsze','Miłoszewski','Zygmunt','2017-11-08','Komedia'),(4,'Labirynt duchów','Zafon Carlos','Ruiz','2017-10-11','Dramat'),(5,'Millennium. Tom 5. Mężczyzna, który gonił swój cień','David','Lagercrantz ','2017-09-07','Horror'),(6,'Pyszne obiady','Anna','Starmach','2016-10-11','Poradnik'),(7,'Początek','Dan','Brown','2012-10-26','Thriller'),(8,'Make Photography Easier','Katarzyna','Tusk','2016-01-01','Poradnik'),(9,'Elementarz stylu','Katarzyna','Tusk','2017-03-03','Poradnik'),(10,'Cel','Elle','Kennedy','2010-09-09','Dramat');
...
CREATE TABLE `uzytkownicy` (
  ...
  `NAZWA_UZY` varchar(20) COLLATE utf8mb4_polish_ci NOT NULL,
  `HASLO` varchar(20) COLLATE utf8mb4_polish_ci NOT NULL,
  `IMIONA_UZY` varchar(45) COLLATE utf8mb4_polish_ci NOT NULL,
  `NAZWISKO_UZY` varchar(45) COLLATE utf8mb4_polish_ci NOT NULL,
  `PESEL` varchar(45) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `EMAIL` varchar(255) COLLATE utf8mb4_polish_ci NOT NULL,
  `TELEFON` int(11) DEFAULT NULL,
  `DATA_UTWORZENIA` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID_UZYTKOWNIKA`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci COMMENT='tabela uzytkownikoa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `uzytkownicy` VALUES (1,'przemeksta','xxxx','Przemek','Staszyński','','przmek.sta@brak.pl',798652231,'2017-10-13 11:29:35'),(2,'lukaszbaryczka','xxxx','Łukasz',' Baryczka',NULL,'LukaszBaryczka@brak.pl',895256321,'2017-10-13 11:36:05'),(3,'izabelapabich','xxxx','Izabela','Pabich',NULL,'izabela.pabicha@brak.pl',NULL,'2017-10-14 07:18:02'),(4,'piotrbednarek','xxxx','Piotr','Bednarek',NULL,'piotr.bednarek@brak.pl',NULL,'2017-10-14 07:19:16'),(5,'jacekwróblewski','xxxx','Jacek','Wróblewski',NULL,'jacekwróblewski@brak.pl',NULL,'2017-10-14 07:22:26');
/*!40000 ALTER TABLE `uzytkownicy` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `v_nie_wypozyczone_ksiazki`
--

DROP TABLE IF EXISTS `v_nie_wypozyczone_ksiazki`;
/*!50001 DROP VIEW IF EXISTS `v_nie_wypozyczone_ksiazki`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_nie_wypozyczone_ksiazki` AS SELECT 
 1 AS `Nazwa książki`,
 1 AS `Imie Autora`,
 1 AS `Nazwisko Autora`,
 1 AS `Data wydania`,
 1 AS `Kategoria`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_uzytkownicy`
--

DROP TABLE IF EXISTS `v_uzytkownicy`;
/*!50001 DROP VIEW IF EXISTS `v_uzytkownicy`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_uzytkownicy` AS SELECT 
 1 AS `Id użytkownika`,
 1 AS `Nazwa użytkownika`,
 1 AS `Imiona użytkownika`,
 1 AS `Nazwisko użytkownika`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_wypozyczone_ksiazki`
--

DROP TABLE IF EXISTS `v_wypozyczone_ksiazki`;
/*!50001 DROP VIEW IF EXISTS `v_wypozyczone_ksiazki`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_wypozyczone_ksiazki` AS SELECT 
 1 AS `Nazwa użytkownika`,
 1 AS `Nazwa książki`,
 1 AS `Imiona Autora`,
 1 AS `Nazwisko Autora`*/;
...
CREATE TABLE `wypozyczenia` (
  ...
  `FK_KSIAZKA` int(11) NOT NULL,
  `FK_UZYTKOWNIK` int(11) NOT NULL,
  `DATA_WYPOZYCZENIA` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID_WYPOZYCZENIA`),
  KEY `ksiazki_wypozyczenie_idx` (`FK_KSIAZKA`),
  KEY `uzytkownicy_wypozyczenie_idx` (`FK_UZYTKOWNIK`),
  CONSTRAINT `ksiazki_wypozyczenia` FOREIGN KEY (`FK_KSIAZKA`) REFERENCES `ksiazki` (`ID_KSIAZKI`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `uzytkownicy_wypozyczenia` FOREIGN KEY (`FK_UZYTKOWNIK`) REFERENCES `uzytkownicy` (`ID_UZYTKOWNIKA`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci COMMENT='Tabela łaczaca ksiazki i uzytkownikow';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wypozyczenia` VALUES (1,3,1,'2017-10-13 11:44:26'),(2,1,2,'2017-10-13 11:44:38'),(4,2,2,'2017-10-13 11:44:58');
...
--
-- Final view structure for view `v_nie_wypozyczone_ksiazki`
--
...
/*!50001 VIEW `v_nie_wypozyczone_ksiazki` AS select `ksiazki`.`NAZWA_KSIAZKI` AS `Nazwa książki`,`ksiazki`.`IMIONA_AUTO` AS `Imie Autora`,`ksiazki`.`NAZWISKO_AUTO` AS `Nazwisko Autora`,`ksiazki`.`DATA_WYDANIA` AS `Data wydania`,`ksiazki`.`KATEGORIA` AS `Kategoria` from `ksiazki` where (not(`ksiazki`.`ID_KSIAZKI` in (select `wypozyczenia`.`FK_KSIAZKA` from `wypozyczenia`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_uzytkownicy`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_uzytkownicy` AS select `uzytkownicy`.`ID_UZYTKOWNIKA` AS `Id użytkownika`,`uzytkownicy`.`NAZWA_UZY` AS `Nazwa użytkownika`,`uzytkownicy`.`IMIONA_UZY` AS `Imiona użytkownika`,`uzytkownicy`.`NAZWISKO_UZY` AS `Nazwisko użytkownika` from `uzytkownicy` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_wypozyczone_ksiazki`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_wypozyczone_ksiazki` AS select `uzytkownicy`.`NAZWA_UZY` AS `Nazwa użytkownika`,`ksiazki`.`NAZWA_KSIAZKI` AS `Nazwa książki`,`ksiazki`.`IMIONA_AUTO` AS `Imiona Autora`,`ksiazki`.`NAZWISKO_AUTO` AS `Nazwisko Autora` from ((`ksiazki` join `uzytkownicy`) join `wypozyczenia`) where ((`ksiazki`.`ID_KSIAZKI` = `wypozyczenia`.`FK_KSIAZKA`) and (`uzytkownicy`.`ID_UZYTKOWNIKA` = `wypozyczenia`.`FK_UZYTKOWNIK`)) order by `uzytkownicy`.`NAZWA_UZY` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-10-22 12:25:48
